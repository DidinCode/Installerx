...
if [ "$SELECT_THEME" -eq 1 ]; then
  ...
  echo -e "                                                                   "
    ...
    echo -e "${YELLOW}Masukkan link wa (https://wa.me/6289505750214) : ${NC}"
    read LINK_WA
    echo -e "${YELLOW}Masukkan link group (https://whatsapp.com/channel/0029VagNjZuHFxOuK3Pzm20L) : ${NC}"
    read LINK_GROUP
    echo -e "${YELLOW}Masukkan link channel (https://whatsapp.com/channel/0029VagNjZuHFxOuK3Pzm20L) : ${NC}"
    read LINK_CHNL
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer ✘ ᴅɪᴅɪɴ ᴄᴏᴅᴇ   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      -----------------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : @DidinCode         ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support By ✘ ᴅɪᴅɪɴ ᴄᴏᴅᴇ ✘  ${NC}"
